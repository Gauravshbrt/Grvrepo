...
while @i < 1001
begin
--create table emp_details_test(emp_no int ,emp_lname Varchar(30),emp_fname Varchar(30),Dept_no Varchar(10))

--SELECT * FROM emp_details

Insert into emp_details_test 
